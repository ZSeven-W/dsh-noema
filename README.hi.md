...
<p align="center">
  <sub>npm: <a href="https://www.npmjs.com/package/@zseven-w/dsh-noema"><code>@zseven-w/dsh-noema</code></a> · वर्तमान प्लगइन रिलीज़: <code>0.1.0-rc.1</code> · DSH <code>0.1.0-rc.6</code> के साथ परीक्षण किया गया</sub>
</p>
...
पहले बूट के बाद, प्लगइन को फिर कभी पुनः आरंभ करने की आवश्यकता नहीं होती: `npm run build` Cordis HMR के माध्यम से होस्ट प्लगइन को हॉट-रीलोड करता है, और `npm run build:client` client-hmr SSE चैनल पर ब्राउज़र बंडल को हॉट-स्वैप करता है।
...
- **क्लाइंट बंडल** — `npm run build:client` `lib/client.js` को फिर से लिखता है; client-hmr node भाग हर ग्राफ बंडल को stat-पोल करता है (डिफ़ॉल्ट 500ms) और `/plugins/events` SSE चैनल पर एक `rebuilt` फ़्रेम प्रसारित करता है, और ब्राउज़र पृष्ठ रीफ़्रेश के बिना मॉड्यूल को हॉट-स्वैप करता है।
