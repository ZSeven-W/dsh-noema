...
<p align="center">
  <sub>npm: <a href="https://www.npmjs.com/package/@zseven-w/dsh-noema"><code>@zseven-w/dsh-noema</code></a> · 현재 플러그인 릴리스: <code>0.1.0-rc.2</code> · DSH <code>0.1.0-rc.6</code>으로 테스트됨</sub>
</p>
