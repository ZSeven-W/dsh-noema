...
<p align="center">
  <sub>npm: <a href="https://www.npmjs.com/package/@zseven-w/dsh-noema"><code>@zseven-w/dsh-noema</code></a> · 当前插件版本：<code>0.1.0-rc.2</code> · 已通过 DSH <code>0.1.1-rc.1</code> 测试</sub>
</p>
