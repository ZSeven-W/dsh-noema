...
<p align="center">
  <sub>npm: <a href="https://www.npmjs.com/package/@zseven-w/dsh-noema"><code>@zseven-w/dsh-noema</code></a> · Versão atual do plugin: <code>0.1.0-rc.4</code> · Testado com DSH <code>0.1.5-rc.1</code></sub>
</p>
