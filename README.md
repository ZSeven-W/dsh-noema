...
<p align="center">
  <sub>npm: <a href="https://www.npmjs.com/package/@zseven-w/dsh-noema"><code>@zseven-w/dsh-noema</code></a> · Current plugin release: <code>0.1.0-rc.2</code> · Tested with DSH <code>0.1.1-rc.1</code></sub>
</p>
